...
PORT_CFLAGS = -O2 -DPREALLOCATE=1 -mcmodel=medany  -fno-tree-loop-distribute-patterns -static -std=gnu99 -fno-common -nostdlib -nostartfiles -lm -lgcc -T $(PORT_DIR)/link.ld
