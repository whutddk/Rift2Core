...
class Decode32 (x:UInt, pc: UInt) {
  ...
  def is_iType = info.bru_isa.jalr | info.lsu_isa.lb | info.lsu_isa.lh |info.lsu_isa.lw | info.lsu_isa.lbu | info.lsu_isa.lhu | info.lsu_isa.lwu | info.lsu_isa.ld | info.alu_isa.addi | info.alu_isa.addiw | info.alu_isa.slti | info.alu_isa.sltiu | info.alu_isa.xori | info.alu_isa.ori | info.alu_isa.andi | info.lsu_isa.fence | info.lsu_isa.fence_i | info.csr_isa.rw | info.csr_isa.rs | info.csr_isa.rc | info.csr_isa.rwi | info.csr_isa.rsi | info.csr_isa.rci | info.lsu_isa.flw | info.lsu_isa.fld | info.fpu_isa.fcsr_rwi | info.fpu_isa.fcsr_rsi | info.fpu_isa.fcsr_rci
  ...
  def is_mType = info.fpu_isa.is_fpu & ~(info.fpu_isa.fcsr_rwi | info.fpu_isa.fcsr_rsi | info.fpu_isa.fcsr_rci)
