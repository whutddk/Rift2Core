...
trait VDecode32{ this: DecodeBase =>
  ...
  info.lsuIsa.vlNre8    := ( x === BitPat("b????00?01000?????000?????0000111") )
  info.lsuIsa.vlNre16   := ( x === BitPat("b????00?01000?????101?????0000111") )
  info.lsuIsa.vlNre32   := ( x === BitPat("b????00?01000?????110?????0000111") )
  info.lsuIsa.vlNre64   := ( x === BitPat("b????00?01000?????111?????0000111") )
...
trait NVDecode{ this: DecodeBase =>
  ...
  info.lsuIsa.vlNre8    := false.B
  info.lsuIsa.vlNre16   := false.B
  info.lsuIsa.vlNre32   := false.B
  info.lsuIsa.vlNre64   := false.B
