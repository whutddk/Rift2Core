...
//   */
// abstract class slv_acquire( implicit level: Int, dw: Int, aw: Int, bk: Int, cb: Int, cl: Int ) extends TLC_base(){
...
//   val info_slvAcquire_address = RegEnable( slv_chn_a.bits.address, is_slvAcquire_allowen )
//   val info_slvAcquire_source  = RegEnable( slv_chn_a.bits.source,  is_slvAcquire_allowen )
